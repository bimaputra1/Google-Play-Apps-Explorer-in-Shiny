...
This shiny apps is a data exploratory tools the see data correlation from Google Play Data in the form of scatter plot and tables. The aims of this shiny app to help user exploring Google Play Apps data based on choosen x and y axis. Data source for this task was donwloaded from Kaggle that include google apps data that last updated on January 2019 which can be found here: https://www.kaggle.com/lava18/google-play-store-apps.
